...
static NSString *const EZBundleId = @"com.anonymxxx.EasydictLite";
static NSString *const EZDebugBundleId = @"com.anonymxxx.EasydictLite-debug";

/// AnonymXXX/Easydict
static NSString *const EZGithubRepoEasydict = @"AnonymXXX/Easydict";
static NSString *const EZGithubRepoEasydictURL = @"https://github.com/AnonymXXX/Easydict";
